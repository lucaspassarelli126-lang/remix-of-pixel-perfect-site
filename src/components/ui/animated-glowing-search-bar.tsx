  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <div id="poda" className="relative flex items-center justify-center group w-full">
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[573px] rounded-xl blur-[3px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[571px] rounded-xl blur-[3px] 
                        before:absolute before:content-[''] before:z-[-2] before:w-[900px] before:h-[900px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-[82deg]
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[566px] rounded-lg blur-[2px] 
                        before:absolute before:content-[''] before:z-[-2] before:w-[900px] before:h-[900px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-[83deg]
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[562px] rounded-xl blur-[0.5px] 
                        before:absolute before:content-[''] before:z-[-2] before:w-[900px] before:h-[900px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-70
        ...
        <div id="main" className="relative group w-full max-w-[560px]">
          <input 
            placeholder="O que você está procurando?" 
            type="text" 
            name="text" 
            className="bg-[#0A1490]/80 backdrop-blur-md border border-white/10 w-full h-[52px] rounded-lg text-white pl-[44px] pr-[52px] md:pl-[50px] md:pr-[54px] text-sm md:text-[15px] focus:outline-none placeholder-white/60 transition-all shadow-inner" 
          />
