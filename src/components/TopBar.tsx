    ...
    <div className="bg-[#0A1490] text-white/90 text-[10px] md:text-xs border-b border-white/10">
      <div className="container flex items-center justify-between py-2">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <a href="https://wa.me/5519995864431" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-[#25D366] transition-colors whitespace-nowrap group">
            <WhatsAppIcon className="h-3.5 w-3.5 text-white/60 group-hover:text-[#25D366] transition-colors" />
