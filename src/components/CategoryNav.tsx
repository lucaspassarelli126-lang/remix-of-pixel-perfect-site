    ...
    <nav className="relative z-40 -mt-5 md:-mt-6 mb-4 md:mb-8">
      <div className="container px-4">
        <div className="mx-auto max-w-5xl">
          <div className="bg-white/90 backdrop-blur-xl border border-white/20 shadow-lg rounded-full px-1 py-1">
            <ul className="flex items-center justify-center gap-0.5 md:gap-1 overflow-x-auto no-scrollbar snap-x">
              {categories.map((cat) => (
