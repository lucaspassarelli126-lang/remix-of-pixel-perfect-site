      ...
      <div className="container">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
          {priceRangeItems.map((range) => (
            ...
            >
              <div className="w-full aspect-[5/3] bg-[#1a3a8a] rounded-md flex flex-col items-start justify-end p-3 group-hover:scale-105 transition-transform shadow-md relative overflow-hidden">
